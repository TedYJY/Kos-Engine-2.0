...
// (like BVH) — for large world meshes you should swap-in a faster structure.
...
//
//    // Compute tile's tileRef by position — detour can find tile by location
//    float bmin[3], bmax[3];
...
//
//    // Keep Recast intermediate data around only if you want to debug — cleanup now
//    CleanupRecast();
//
//    return true;
//}
